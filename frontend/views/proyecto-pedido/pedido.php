    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'before'=>'<em><b><span class="glyphicon glyphicon-user"></span> '.$asignado->nombreUsuario.'</b> - <span class="glyphicon glyphicon-briefcase"></span> '.$asignado->proyectoEspecifica->nombreUnidadEjecutora.'</em>',
