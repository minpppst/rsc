 ...
 */
class ProyectoResponsableAdministrativoController extends \common\controllers\BaseController
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new ProyectoResponsableAdministrativo",
                    'content'=>'<span class="text-success">Create ProyectoResponsableAdministrativo success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"])
    ...
    public function actionDelete($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose'=>true,'forceReload'=>'#administrativo'];
        }else{
            /*
            *   Process for non-ajax request
            */
