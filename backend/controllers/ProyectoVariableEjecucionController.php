...
use backend\models\ProyectoVariableEjecucionSearch;
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new ProyectoVariableEjecucion",
                ...
                return [
                    ...
                    'title'=> "Create new ProyectoVariableEjecucion",
                    'content'=>'<span class="text-success">Create ProyectoVariableEjecucion success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
