...
use common\models\ObjetivosHistoricosSearch;
...
class ObjetivosHistoricosController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new ObjetivosHistoricos",
                ...
                return [
                    ...
                    'title'=> "Create new ObjetivosHistoricos",
                    'content'=>'<span class="text-success">Create ObjetivosHistoricos success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update ObjetivosHistoricos #".$id,
    ...
    /**
     * Delete an existing ObjetivosHistoricos model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ObjetivosHistoricos model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
