...
use common\models\ObjetivosEstrategicosSearch;
...
class ObjetivosEstrategicosController extends \common\controllers\BaseController
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "ObjetivosEstrategicos #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new ObjetivosEstrategicos",
                ...
                return [
                    ...
                    'title'=> "Create new ObjetivosEstrategicos",
                    'content'=>'<span class="text-success">Create ObjetivosEstrategicos success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update ObjetivosEstrategicos #".$id,
    ...
    /**
     * Delete an existing ObjetivosEstrategicos model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ObjetivosEstrategicos model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
