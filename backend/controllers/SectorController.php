 ...
 */
class SectorController extends \common\controllers\BaseController
{
    /**
     * @inheritdoc
     */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Crea nuevo Sector",
                    'content'=>'<span class="text-success">Create Sector success</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Sector model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Sector model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
