...
use common\models\UnidadMedidaSearch;
...
class UnidadMedidaController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Create new UnidadMedida",
                    'content'=>'<span class="text-success">Create UnidadMedida success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing UnidadMedida model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing UnidadMedida model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {        
        ...
        foreach (UnidadMedida::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
