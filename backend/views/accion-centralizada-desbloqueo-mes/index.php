        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Crear Un Nuevo Desbloqueo De Mes','class'=>'btn btn-default']),
            ...
            'panel' => [
                //'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Accion Centralizada Desbloqueo Mes lista',
